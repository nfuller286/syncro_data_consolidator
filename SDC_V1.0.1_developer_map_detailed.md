...
## File Path: syncro_data_consolidator/src/sdc/ingestors/notes_json_ingestor.py
...
## File Path: syncro_data_consolidator/src/sdc/ingestors/screenconnect_log_ingestor.py
...
## File Path: syncro_data_consolidator/src/sdc/ingestors/st_chat_ingestor.py

**Core Purpose:** Ingests ST `.jsonl` chat logs, segments the messages into distinct sessions based on time gaps, transforms each session into the CUIS format, and saves it as a separate file.
...
*   **Function Name:** `ingest_sillytavern_chats`
    *   **Purpose:** Main orchestration function to find, read, segment, and process ST chat logs.
    *   **Key Logic Steps:**
...
## File Path: syncro_data_consolidator/src/sdc/ingestors/syncro_customer_contact_cacher.py
...
## File Path: syncro_data_consolidator/src/sdc/ingestors/syncro_ticket_ingestor.py
...
## File Path: syncro_data_consolidator/src/sdc/models/cuis_v1.py
...
## File Path: syncro_data_consolidator/src/sdc/processors/cuis_customer_linker.py
...
## File Path: syncro_data_consolidator/src/sdc/processors/cuis_embedding_generator.py
...
## File Path: syncro_data_consolidator/src/sdc/processors/cuis_llm_analyzer.py
...
## File Path: syncro_data_consolidator/src/sdc/run_sdc.py
...
## File Path: syncro_data_consolidator/src/sdc/utils/config_loader.py
...
## File Path: syncro_data_consolidator/src/sdc/utils/cuis_handler.py
...
## File Path: syncro_data_consolidator/src/sdc/utils/date_utils.py
...
## File Path: syncro_data_consolidator/src/sdc/utils/llm_utils.py
...
## File Path: syncro_data_consolidator/src/sdc/utils/sdc_logger.py
