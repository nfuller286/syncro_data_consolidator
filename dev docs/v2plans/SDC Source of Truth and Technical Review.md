...
*   **`recursive_sillytavern_scan`**: A boolean (`true`) to scan subdirectories for ST chats.
...
*   **Component: `notes_json_ingestor`**
    *   **File:** `syncro_data_consolidator/src/sdc/ingestors/notes_json_ingestor.py`
...
*   **Component: `screenconnect_log_ingestor`**
    *   **File:** `syncro_data_consolidator/src/sdc/ingestors/screenconnect_log_ingestor.py`
...
*   **Component: `st_chat_ingestor`**
    *   **File:** `syncro_data_consolidator/src/sdc/ingestors/st_chat_ingestor.py`
    *   **Purpose:** Ingestor for ST chat logs in .jsonl format.
    *   **Key Functions/Methods:**
        ...
        *   `ingest_sillytavern_chats(config: Dict[str, Any], logger) -> None`: Loads ST .jsonl chat logs, deduplicates messages, segments them into sessions based on time gaps, transforms them into the V2 Session format, and saves them as individual JSON files.
    *   **Attributes/Fields (if it is a data model):**
        *   Not applicable; this module contains processing functions, not a data model.
*   **Component: `syncro_customer_contact_cacher`**
    *   **File:** `syncro_data_consolidator/src/sdc/ingestors/syncro_customer_contact_cacher.py`
...
*   **Component: `syncro_ticket_ingestor`**
    *   **File:** `syncro_data_consolidator/src/sdc/ingestors/syncro_ticket_ingestor.py`
...
*   **Component: `session_v2.py` (Module)**
    *   **File:** `syncro_data_consolidator/src/sdc/models/session_v2.py`
...
*   **Component: `session_embedding_generator.py`**
    *   **File:** `syncro_data_consolidator/src/sdc/processors/session_embedding_generator.py`
...
*   **Component: `session_customer_linker`**
    *   **File:** `syncro_data_consolidator/src/sdc/processors/session_customer_linker.py`
...
*   **Component: `session_llm_analyzer`**
    *   **File:** `syncro_data_consolidator/src/sdc/processors/session_llm_analyzer.py`
    ...
    *   **Attributes/Fields (if it is a data model):**
        *   Not applicable (this is a processing module, not a data model).
*   **Component: `run_sdc`**
    *   **File:** `syncro_data_consolidator/src/sdc/run_sdc.py`
...
*   **Component: `cache_utils`**
    *   **File:** `syncro_data_consolidator/src/sdc/utils/cache_utils.py`
...
*   **Component: `config_loader`**
    *   **File:** `syncro_data_consolidator/src/sdc/utils/config_loader.py`
...
*   **Component: `date_utils`**
    *   **File:** `syncro_data_consolidator/src/sdc/utils/date_utils.py`
...
*   **Component: `llm_utils`**
    *   **File:** `syncro_data_consolidator/src/sdc/utils/llm_utils.py`
...
*   **Component: `sdc_logger`**
    *   **File:** `syncro_data_consolidator/src/sdc/utils/sdc_logger.py`
...
*   **Component: `session_handler`**
    *   **File:** `syncro_data_consolidator/src/sdc/utils/session_handler.py`
